...
PusherChatWidget.prototype._sendChatButtonClicked = function() {
  var nickname = $.trim(this._nicknameEl.val());
  if(!nickname) {
    alert('Bitte gib einen Nicknamen an!');
    return;
  }
  ...
  '<div class="pusher-chat-widget">' +
    ...
    '<div class="pusher-chat-widget-messages">' +
      '<ul class="activity-stream">' +
        '<li class="waiting">Es wurde noch keine Nachricht gesendet</li>' +
      '</ul>' +
    '</div>' +
    '<div class="pusher-chat-widget-input">' +
      '<label for="message">Nachricht</label>' +
      '<textarea name="message"></textarea>' +
      '<button class="pusher-chat-widget-send-btn">Senden</button>' +
    '</div>' +
